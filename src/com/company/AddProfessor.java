...
/**
 * This class is a panel in which admin adds professor.
 */
public class AddProfessor extends Background {
    JTextField userTxt;
    ...
    public AddProfessor(){
        ...
        TitledBorder titledBorder = new TitledBorder(new LineBorder(Color.BLACK),"Add Professor");
        ...
        public void actionPerformed(ActionEvent e){
            if (e.getSource().equals(save)){
                ...
                if (user.trim().equals("") || pass.trim().equals("")){
                    ...
                    if (Admin.addProfessor(user,pass)){
                        JOptionPane.showMessageDialog(null, "Professor saved successfully.",
